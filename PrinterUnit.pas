...
procedure TPrinter.VisitFuncDeclExpr(AFuncDeclExpr: TFuncDeclExpr);
begin
  IncIndent;
  VisitNode(AFuncDeclExpr);
...
procedure TPrinter.VisitInterpolatedExpr(AInterpolatedExpr: TInterpolatedExpr);
var
  Expr: TExpr;
begin
  IncIndent;
  VisitNode(AInterpolatedExpr);
...
procedure TPrinter.VisitListExpr(AListExpr: TListExpr);
var
  Expr: TExpr;
begin
  IncIndent;
